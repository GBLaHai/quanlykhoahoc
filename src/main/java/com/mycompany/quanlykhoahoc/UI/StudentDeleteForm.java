 ...
 * @author Manh Hai
 */
public class StudentDeleteForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel_FormTitle.setText("Delete Student");
        ...
        jButton_Delete_.setText("Delete Student");
    ...
    private void jButton_Delete_ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_Delete_ActionPerformed
        ...
        try {
            ...
            Student s = studentBLL.getStudent(id);
            ...
            if (confirm == JOptionPane.YES_OPTION) {
                if (studentBLL.deleteStudent(id) > 0) {
                    JOptionPane.showMessageDialog(null, "Student deleted", "Notification", 1);
                } else {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(StudentDeleteForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
