...
public class OnlineCourseEditForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel_FormTitle.setText("Edit Online Course");
            ...
            .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(jPanel2Layout.createSequentialGroup()
                    ...
                    .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        ...
                        .addComponent(jTextField_Url, javax.swing.GroupLayout.DEFAULT_SIZE, 392, Short.MAX_VALUE))
    ...
    private void jButton_Edit_ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_Edit_ActionPerformed
        try {
            ...
            if (title.trim().isEmpty()) {
                ...
                jTextField_Url.setVisible(true);
            } else {
    ...
    private void jButton_SearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_SearchActionPerformed
        ...
        try {
            ...
            jTextField_Url.setText(course.getUrl());
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new OnlineCourseEditForm().setVisible(true);
            }
        });
    }
