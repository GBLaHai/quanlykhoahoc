...
public class TeacherAddForm extends javax.swing.JFrame {
    ...
    public TeacherAddForm() {
        ...
        Date date_hire = null;
        try {
            date_hire = new SimpleDateFormat("yyyy-MM-dd").parse(LocalDate.now().toString());
    ...
    private void initComponents() {
        ...
        jLabel_FormTitle.setText("Add Teacher");
        ...
        jButton_Add_.setText("Add New Teacher");
    ...
    private void jButton_Add_MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton_Add_MouseClicked
        ...
        if (firstName.trim().isEmpty()) {
            ...
            Teacher teacher = new Teacher(firstName, lastName, hireDate);
            if (teacherBLL.addTeacher(teacher) <= 0) {
                JOptionPane.showMessageDialog(null, "Teacher not added", "Notification", 2);
            } else {
                JOptionPane.showMessageDialog(null, "Teacher added", "Notification", 1);
            }
        }
