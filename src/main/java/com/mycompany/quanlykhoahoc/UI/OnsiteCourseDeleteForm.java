 ...
 * @author Manh Hai
 */
public class OnsiteCourseDeleteForm extends javax.swing.JFrame {

    OnsiteCourseBLL onsiteCourseBLL = new OnsiteCourseBLL();

    public OnsiteCourseDeleteForm() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel_FormTitle.setText("Delete Onsite Course");
        ...
        jButton_Delete_.setText("Delete Onsite Course");
    ...
    private void jButton_Delete_ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_Delete_ActionPerformed
        ...
        try {
            ...
            int confirm = JOptionPane.showConfirmDialog(null, "Are you sure to delete this student?", "Notification", JOptionPane.YES_NO_OPTION);

            if (confirm == JOptionPane.YES_OPTION) {
                if (onsiteCourseBLL.deleteOnsiteCourse(id) > 0) {
                    JOptionPane.showMessageDialog(null, "Onsite course deleted", "Notification", 1);
                } else {
                    JOptionPane.showMessageDialog(null, "No onsite course with this id is found", "Notification", 3);
                }
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(OnsiteCourseDeleteForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new OnsiteCourseDeleteForm().setVisible(true);
            }
        });
    }
