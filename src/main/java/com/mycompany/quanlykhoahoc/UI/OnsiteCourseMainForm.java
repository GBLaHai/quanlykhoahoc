...
public class OnsiteCourseMainForm extends javax.swing.JPanel {
    ...
    private void btn_themMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn_themMouseClicked
        OnsiteCourseAddForm addForm = new OnsiteCourseAddForm();
        addForm.setVisible(true);
    }//GEN-LAST:event_btn_themMouseClicked

    private void btn_suaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn_suaMouseClicked
        OnsiteCourseEditForm courseEditForm = new OnsiteCourseEditForm();
    ...
    private void btn_xoaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn_xoaMouseClicked
        OnsiteCourseDeleteForm courseDeleteForm = new OnsiteCourseDeleteForm();
    ...
    public void populateJtableWithStudents(int trang) {
        ArrayList<OnsiteCourse> onsiteCourseList = (ArrayList<OnsiteCourse>) onsiteCourseBLL.LoadOnsiteCourses(trang);
        
        // jtable columns
        String[] colNames = {"ID","TITLE", "CREDITS","LOCATION", "DEPARTMENT"};
        ...
        for(int i = 0; i < onsiteCourseList.size(); i++) {
            ...
            rows[i][3] = onsiteCourseList.get(i).getDepartmentName();
            rows[i][4] = onsiteCourseList.get(i).getLocation();
        }
    ...
    private void setPagination() {
        count = onsiteCourseBLL.countRecordOnsiteCourse();
        if(count % 15 == 0) {
            soTrang = count / 15;
        } else {
            soTrang = count / 15 + 1;
    ...
    public void populateJtableWithFullname(String title) {
        ArrayList<OnsiteCourse> onsiteCourseList = (ArrayList<OnsiteCourse>) onsiteCourseBLL.findOnsiteCourse(title);
