...
public class StudentGradeMainForm extends javax.swing.JPanel {
    ...
    private void btn_suaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn_suaMouseClicked
        StudentGradeEditForm editForm = new StudentGradeEditForm();
    ...
    private void btn_xoaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn_xoaMouseClicked
        StudentGradeDeleteForm deleteForm = new StudentGradeDeleteForm();
    ...
    public void populateJtableWithStudents(int trang) {
        ArrayList<StudentGrade> studentGradeList = (ArrayList<StudentGrade>) studentGradeBLL.LoadStudentGrades(trang);
        
        // jtable columns
        String[] colNames = {"ID","STUDENTID", "FULLNAME","COURSEID", "TITLE"};
        ...
        Object[][] rows = new Object[studentGradeList.size()][colNames.length];
         ...
         for(int i = 0; i < studentGradeList.size(); i++) {
            ...
            rows[i][1] = studentGradeList.get(i).getStudentID();
            rows[i][2] = studentGradeList.get(i).getFirstName() + " " + studentGradeList.get(i).getLastName();
            rows[i][3] = studentGradeList.get(i).getCourseID();
            rows[i][4] = studentGradeList.get(i).getTitle();
        }
    ...
    private void setPagination() {
        count = studentGradeBLL.countRecordStudentGrade();
        if(count % 15 == 0) {
            soTrang = count / 15;
        } else {
            soTrang = count / 15 + 1;
    ...
    public void populateJtableWithFullname(String studentID) {
        ArrayList<StudentGrade> studentGradeList = (ArrayList<StudentGrade>) studentGradeBLL.findStudentGrade(studentID);
