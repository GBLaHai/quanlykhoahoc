 ...
 * @author Manh Hai
 */
public class TeacherDeleteForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel_FormTitle.setText("Delete Teacher");
    ...
    private void jButton_Delete_ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_Delete_ActionPerformed
        ...
        try {
            ...
            Teacher t = teacherBLL.getTeacher(id);
            
            int confirm = JOptionPane.showConfirmDialog(null, "Are you sure to delete this teacher?", "Notification", JOptionPane.YES_NO_OPTION);

            if (confirm == JOptionPane.YES_OPTION) {
                if (teacherBLL.deleteTeacher(id) > 0) {
                    JOptionPane.showMessageDialog(null, "Teacher deleted", "Notification", 1);
                } else {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TeacherDeleteForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TeacherDeleteForm().setVisible(true);
            }
        });
    }
