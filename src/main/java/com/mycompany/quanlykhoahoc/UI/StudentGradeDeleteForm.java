 ...
 * @author Manh Hai
 */
public class StudentGradeDeleteForm extends javax.swing.JFrame {

    StudentGradeBLL studentGradeBLL = new StudentGradeBLL();

    public StudentGradeDeleteForm() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel_FormTitle.setText("Delete Student Grade");
    ...
    private void jButton_Delete_ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_Delete_ActionPerformed
        ...
        try {
            ...
            int confirm = JOptionPane.showConfirmDialog(null, "Are you sure to delete this student grade?", "Notification", JOptionPane.YES_NO_OPTION);

            if (confirm == JOptionPane.YES_OPTION) {
                if (studentGradeBLL.deleteStudentGrade(id) > 0) {
                    JOptionPane.showMessageDialog(null, "Student grade deleted", "Notification", 1);
                } else {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(StudentGradeDeleteForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new StudentGradeDeleteForm().setVisible(true);
            }
        });
    }
