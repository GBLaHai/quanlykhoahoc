...
-- Database: `School`
--
CREATE DATABASE IF NOT EXISTS `quanlykhoahoc` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `quanlykhoahoc`;
...
--
ALTER TABLE `OnlineCourse`
  ADD CONSTRAINT `fk_onlinecourse_course` FOREIGN KEY (`CourseID`) REFERENCES `Course` (`CourseID`);
  
ALTER TABLE `OnsiteCourse`
  ADD CONSTRAINT `fk_onsitecourse_course` FOREIGN KEY (`CourseID`) REFERENCES `Course` (`CourseID`);
  
ALTER TABLE `StudentGrade`
  ADD CONSTRAINT `fk_studentgrade_person` FOREIGN KEY (`StudentID`) REFERENCES `Person` (`PersonID`);
  
ALTER TABLE `StudentGrade`
  ADD CONSTRAINT `fk_studentgrade_course` FOREIGN KEY (`CourseID`) REFERENCES `Course` (`CourseID`);
  
ALTER TABLE `Course`
  ADD CONSTRAINT `fk_course_department` FOREIGN KEY (`DepartmentID`) REFERENCES `Department` (`DepartmentID`);
  
ALTER TABLE `CourseInstructor`
  ADD CONSTRAINT `fk_courseinstructor_person` FOREIGN KEY (`PersonID`) REFERENCES `Person` (`PersonID`);
  
ALTER TABLE `CourseInstructor`
  ADD CONSTRAINT `fk_courseinstructor_course` FOREIGN KEY (`CourseID`) REFERENCES `Course` (`CourseID`);
